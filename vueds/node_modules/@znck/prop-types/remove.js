      ...
      Identifier(path) {
        ...
        if (prop) {
          ...
          if (info.isBoolean) {
            ...
            newProps.properties.push(t.objectProperty(t.identifier(prop.node.key.name), t.objectExpression([t.objectProperty(t.identifier('default'), info.default.node)])));
          } else {
            newProps.properties.push(t.objectProperty(t.identifier(prop.node.key.name), t.objectExpression([])));
          }
